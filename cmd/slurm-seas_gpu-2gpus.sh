...
#SBATCH -o /n/home06/zhentingqi/slurm_out/debug_%j.out       # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /n/home06/zhentingqi/slurm_out/debug_%j.err       # File to which STDERR will be written, %j inserts jobid
...
# --- run your code here ---
bash rc-jobs/debug-multigpu.sh
# --------------------------
